from aoc2020.d02 import splitRegex, isPassValid, isPassValid2
...
class TestPasswdValid(TestCase):
    def test_Example1(self):
        ...
        self.assertEqual(isPassValid(groups), True)

    def test_Example2(self):
        groups = splitRegex.search("1-3 b: cdefg").groups()
        self.assertEqual(isPassValid(groups), False)
...
class TestPasswdValid_Mode2(TestCase):
    def test_TooShort(self):
        ...
        self.assertEqual(isPassValid2(groups), False)

    def test_Example1(self):
        groups = splitRegex.search("1-3 a: abcde").groups()
        self.assertEqual(isPassValid2(groups), True)
